 ...
 *     
 */
public class X509CertificateRetrieverAttribute implements X509CertificateRetriever {
	...
	public X509CertificateRetrieverAttribute(String certAttrName) {
		this.certAttrName = certAttrName == null ? DEFAULT_X509_CERTIFICATE_ATTRIBUTE_NAME : certAttrName;
	}
	public X509CertificateRetrieverAttribute() {
		this(null);
	}
